...
unix_time = "t_" + str(int(time.time())) + "_"

args = parser.parse_args()
if not os.path.isdir("results/" + args.dataset + '_' + args.train_dir):
    os.makedirs("results/" + args.dataset + '_' + args.train_dir)
with open(os.path.join("results/" + args.dataset + '_' + args.train_dir, unix_time+'args.txt'), 'w') as f:
...
f = open(os.path.join("results/" + args.dataset + '_' + args.train_dir, unix_time+'log.txt'), 'w')
